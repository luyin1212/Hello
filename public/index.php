    ...
    <div class="col-md-3 mb-4">
        <div class="card border-success">
            <div class="card-body text-center">
                ...
                <?php
                    /**
                     * ALGORITHM: Aggregation - SUM
                     * 
                     * Purpose: Calculate total revenue from all invoices
                     * Algorithm Type: Aggregation (SQL SUM function)
                     * Time Complexity: O(n) where n = number of invoices
                     * 
                     * This represents the total income generated by the business
                     * from all sales transactions in the system.
                     */
                    $result = $db->query("SELECT SUM(totalAmount) as total FROM invoice");
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p><strong>Database:</strong> smart_inventory</p>
